...
int main(void)
{
  ...
  uart_init(460800);	//串口初始化波特率为115200
	
	{
		LED3=0;delay_ms(100);LED4=0;delay_ms(100);LED5=0;delay_ms(100);
	  LED3=1;delay_ms(100);LED4=1;delay_ms(100);LED5=1;delay_ms(100);
		printf("begin\r\n");
	}
  while(1)
	      ...
	      predict[(count-4)%1000]==predict[(count-5)%1000])
	     {
		  switch(motiondetect)
		  {
			case 0:
			  ...
			  //模式1
		    {LED3=1;LED4=1;LED5=1;LED3=0;LED4=1;PFout(7)=1;}
			  break;
			case 1:
			  USART_SendData(USART1, 'P');
			  //模式2
		    {LED3=1;LED4=1;PFout(7)=1;LED3=1;LED4=0;LED5=1;}
			  break;
			case 2:
			  USART_SendData(USART1, 'R');
		    //模式3
		    {LED3=1;LED4=1;LED5=1;LED3=0;LED4=0;LED5=1;}
			  break;
			case 3:
			  USART_SendData(USART1, 'T');
			  //模式4
		    {LED3=1;LED4=1;LED5=1;LED3=1;LED4=1;LED5=0;}
			  break;
			case 4:
			  USART_SendData(USART1, 'B');
			  //模式5
		    {LED3=1;LED4=1;LED5=1;LED3=0;LED4=1;LED5=0;}
			  break;  
			case 5:
			  USART_SendData(USART1, '0');
			  //模式6
		    {LED3=1;LED4=1;LED5=1;LED3=1;LED4=0;LED5=0;}
			  break;
		    default:			
		      break;
		  }
